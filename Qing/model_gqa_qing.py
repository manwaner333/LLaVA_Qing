...
def eval_model(args):
    ...
    for line in tqdm(questions):
        ...
        # combined_attentions['ques'] = attentions[31][0, -1, ques_end_for_total_idx, ques_start_for_total_idx:ques_end_for_total_idx + 1].detach().cpu().numpy().tolist()
        combined_attentions['ques'] = attentions[31][0, :, ques_start_for_total_idx:ques_end_for_total_idx + 1, ques_start_for_total_idx:ques_end_for_total_idx + 1].detach().cpu().numpy().tolist()
